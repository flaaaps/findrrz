...
// const REDIRECT_URI = process.env.NODE_ENV === "development" ? "http://192.168.1.7:3000" : "https://findrrz.hardboun.de"
    ...
    return (
        <>
            <div className="px-6 mt-20">
                <button onClick={() => authorizeWithSpotify()}>Login with Spotify</button>
            </div>
        </>
    )
}
