...
const TrackAudioControls: React.FC<Props> = ({ volume, setVolume }) => {
    const max = 0.45
    ...
    return (
        <motion.div
            className="absolute top-0 right-0 z-30 mr-5 p-2 pb-10 flex flex-col items-center mt-20"
            ...
            <AnimatePresence>
                {expanded && (
                    ...
                    >
                        <motion.div
                            key="circle"
                            className="absolute -left-1 w-3 h-3.5 rounded-full bg-primary shadow-md"
                            style={{ y }}
                            drag="y"
...
export default TrackAudioControls
